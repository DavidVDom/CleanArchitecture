...
{
    // se usará esta clase de extensión usando el package Bogus
    public static class SeedDataExtensions
    {
        ...
        public static void SeedDataAuthentication(this IApplicationBuilder app)
        {
            ...
            var service = scope.ServiceProvider; // con ServiceProvider podemos crear un objeto de cualquier tipo de clase
        ...
        {
            // otra forma de crear un IServiceScope
            using var scope = app.ApplicationServices.CreateScope();
            ...
            for (var i = 0; i < 100; i++)
            {
                // observar que Bogus tiene varias formas de generar cosas como Vins, etc.
                vehiculos.Add(new
                {
                    Id = Guid.NewGuid(),
                    ...
                    Departamento = faker.Address.State(),// equivalente
            ...
            // usamos Dapper para insertar
            const string sql = """
                    INSERT INTO public.vehiculos
                        (id, vin, modelo, direccion_pais, direccion_departamento, direccion_provincia, direccion_ciudad, direccion_calle,
                        precio_monto, precio_tipo_moneda, mantenimiento_monto, mantenimiento_tipo_moneda, accesorios, fecha_ultima_alquiler)
                    values(@id, @Vin,@Modelo,@Pais, @Departamento, @Provincia, @Ciudad, @Calle,
                        @PrecioMonto, @PrecioTipoMoneda, @PrecioMantenimiento, @PrecioMantenimientoTipoMoneda, @Accesorios, @FechaUltima)
                """;

...
{
    // tener en cuenta que para la configuración estamos usando clases de configuración en infrastructure, con lo cual al crear
    // migraciones va a dar problemas porque buscará un constructor, por lo tanto, creamos aquí un constructor privado (también debe tener
    ...
    )
    {
        ...
        // publicamos un evento en un queue, y otro componente a futuro consumirá ese evento y hará algo
        // cada vez que genero un alquiler con estado de reservar, se envía ese mensaje
